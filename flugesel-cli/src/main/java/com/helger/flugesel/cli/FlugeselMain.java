...
/**
 * Command-line front-end for flugesel. Wraps the four library entry points as picocli
 * subcommands.
 *
 * @author Philip Helger
 */
@Command (name = "flugesel",
...
public final class FlugeselMain
{
  public static void main (final String [] aArgs)
  {
    final CommandLine cmd = new CommandLine (new FlugeselMain ());
