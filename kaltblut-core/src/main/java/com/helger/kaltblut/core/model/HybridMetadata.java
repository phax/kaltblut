 ...
 * <code>fx:DocumentFileName</code>, <code>fx:Version</code>,
 * <code>fx:ConformanceLevel</code>),</li>
...
public final class HybridMetadata
{
  ...
  /**
   * @return the <code>fx:Version</code> / <code>zf:Version</code> value (e.g. <code>1.0</code>,
   *         <code>1p0</code>, <code>2p0</code>).
   */
  @Nullable
  ...
  /**
   * @return the file name on the embedded-file <code>/F</code> entry, or <code>null</code> if there
  ...
  {
    return new ToStringGenerator (null).append ("Flavor", m_eFlavor)
                                       .append ("NamespaceURI", m_sNamespaceURI)
                                       .append ("XmpDocumentType", m_sXmpDocumentType)
                                       .append ("XmpDocumentFileName", m_sXmpDocumentFileName)
                                       .append ("XmpVersion", m_sXmpVersion)
                                       .append ("Profile", m_eProfile)
                                       .append ("RawProfile", m_sRawProfile)
                                       .append ("EmbeddedFileName", m_sEmbeddedFileName)
