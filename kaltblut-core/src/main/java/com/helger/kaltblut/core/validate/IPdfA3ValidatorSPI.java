 ...
 * <code>kaltblut-verapdf</code> module registers a veraPDF-backed implementation.
 * <code>kaltblut-core</code> ships no default implementation; if none is registered the
 * {@link HybridValidator} will record a single {@link EHybridSeverity#INFORMATION} finding stating
 * that PDF/A-3 validation is not configured.
 *
 * @author Philip Helger
 */
@IsSPIInterface
public interface IPdfA3ValidatorSPI
{
  /**
   ...
   */
  @NonNull
  ICommonsList <HybridFinding> validatePdfA3 (@NonNull IHybridSource aSource) throws IOException;
}
