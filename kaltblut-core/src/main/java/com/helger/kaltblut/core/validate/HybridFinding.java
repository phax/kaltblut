 ...
 */
@Immutable
public final class HybridFinding
{
  private final String m_sRuleID;
  private final EHybridSeverity m_eSeverity;
  private final String m_sMessage;
  private final String m_sLocation;

  public HybridFinding (@NonNull final String sRuleID,
                        @NonNull final EHybridSeverity eSeverity,
  ...
  @NonNull
  public EHybridSeverity getSeverity ()
  {
    return m_eSeverity;
  }
  ...
  /**
   * @param eNewSeverity
   *        The new severity to use. May not be <code>null</code>.
   * @return a copy of this finding with a downgraded severity.
   */
  @NonNull
  public HybridFinding withSeverity (@NonNull final EHybridSeverity eNewSeverity)
  {
    ValueEnforcer.notNull (eNewSeverity, "NewSeverity");
    if (m_eSeverity == eNewSeverity)
      return this;

    return new HybridFinding (m_sRuleID, eNewSeverity, m_sMessage, m_sLocation);
  }
  ...
  {
    return new ToStringGenerator (null).append ("RuleID", m_sRuleID)
