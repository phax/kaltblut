 ...
 * kaltblut-testfiles. One test per distinct PDF-carrier generation.
 *
...
public final class HybridInspectorTest
{
  ...
  {
    final HybridMetadata aMeta = HybridInspector.readMetadata (HybridSource.fromClasspath (KaltblutTestFiles.ZF_2_0_1_EN16931));
  ...
  {
    final HybridMetadata aMeta = HybridInspector.readMetadata (HybridSource.fromClasspath (KaltblutTestFiles.ZF_2_1_EN16931_EMBEDDED));
    assertTrue (aMeta.isRecognisedHybridInvoice ());
  ...
  {
    final HybridMetadata aMeta = HybridInspector.readMetadata (HybridSource.fromClasspath (KaltblutTestFiles.ZF_2_2_XRECHNUNG));
    assertEquals (EZugferdFlavor.FACTURX_PRIMARY, aMeta.getFlavor ());
  ...
  {
    final HybridMetadata aMeta = HybridInspector.readMetadata (HybridSource.fromClasspath (KaltblutTestFiles.ZF_2_3_MINIMUM));
  ...
  {
    final HybridMetadata aMeta = HybridInspector.readMetadata (HybridSource.fromClasspath (KaltblutTestFiles.ZF_2_4_BASIC_WL));
    assertEquals (EZugferdFlavor.FACTURX_PRIMARY, aMeta.getFlavor ());
  ...
  {
    assertTrue (HybridInspector.isHybridInvoice (HybridSource.fromClasspath (KaltblutTestFiles.ZF_2_0_1_EN16931)));
  }
}
